    ...
    return (
      <div>
        ...
        <div className={`logo-gather-demo-edit-wrapper ${this.state.show ? 'open' : ''}`}>
          {
            this.state.isMode && (<div className="edit-button" onClick={this.phoneClick}><Icon type="down" /></div>)
          }
          <ul>
            <li>图片：</li>
            <li>
              <RadioGroup onChange={this.onChangeRadio} defaultValue="a">
                <Radio value="a">
                  <img alt="antd" src={this.defaultImage.a} height="30" />
                </Radio>
                <Radio value="b">
                  <img alt="ant motion" src={this.defaultImage.b} height="30" />
                </Radio>
                <Radio value="c">
                  <img alt="react" src={this.defaultImage.c} height="30" />
                </Radio>
            ...
            <li className={`${this.state.isMode ? 'phone-float-none' : ''}`} >
              <Button onClick={this.onClick} type="primary" >更新</Button>
            </li>
          </ul>
