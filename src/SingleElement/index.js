...
class SingleElement extends Component {
	...
	render() {
		return (
			...
			// <TweenOne className="exampleContent" animation={{ SVGDraw: 0 }} />

			// <TweenOne  className="exampleContent" animation={{ d: 'M0 0L100 100', attr: 'attr' }}> <div>demo</div> </TweenOne>

			// <TweenOne className="exampleContent" animation={{ path: 'M0,100 C30,60 0,20 50,50 C70,70 60,0 100,0' }}><div>demo</div></TweenOne>
